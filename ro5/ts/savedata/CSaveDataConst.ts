...
export class CSaveDataConst {
     ...
     * プロパティ名：補助ステータス（射程）.
     */
    // @ts-expect-error TS(2300): Duplicate identifier 'propNameStRange'.
    static propNameStRange = "stRange";

    /**
     * プロパティ名：補助ステータス（除算Def）.
     */
    // @ts-expect-error TS(2300): Duplicate identifier 'propNameStDefDiv'.
    static propNameStDefDiv = "stDefDiv";

    /**
     * プロパティ名：補助ステータス（除算Mdef）.
     */
    // @ts-expect-error TS(2300): Duplicate identifier 'propNameStMdefDiv'.
    static propNameStMdefDiv = "stMdefDiv";
