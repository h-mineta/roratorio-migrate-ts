import { ConvertDataTextMIG } from "../saveload";
...
import * as SaveDataUnit from "./CSaveDataUnit";
/**
...
export class CSaveDataUnitParse extends CSaveDataUnitBase {
     ...
     */
    parse(dataText: string, bitOffset: number): number {
    ...
    translateFromOldFormat(dataText) {
        ...
        // バージョン情報
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_VERSION))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset);

        //--------------------------------
        // キャラクターステータス（旧：基本情報＋特性ステータス＋オプション（自動レベル調整））
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_CHARA))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            ((saveDataArrayOld[11] > 0) ? 1 : 0),
            // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_SUPERNOVICE'.
        ...
        for (let idxKind = 0; idxKind < 10; idxKind++) {
            ...
            // データ変換
            saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_EQUIPABLE))();
            [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
                (1 + idxKind),
                0,
                ((1n << 20n) - 1n),
        ...
        // 矢、衣装も装備アイテム扱いにする
        // 矢
        // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_GUNSLINGER'.
        ...
        // 衣装
        // @ts-expect-error TS(2304): Cannot find name 'ITEM_ID_ISHO_BEGINNER_BO'.
        ...
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_EQUIP_REGIONS))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
        ...
        // 習得スキル（旧：習得スキル）
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_LEARNED_SKILLS))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 200n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_CHARA_BUFF))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            saveDataArrayOld[14],
            ((1n << 70n) - 1n),
        ...
        // 自己スキルBUFF（旧：パッシブ持続系）
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_SKILL_BUFF_SELF))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 100n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_SKILL_BUFF_1ST))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 100n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_SKILL_BUFF_2ND))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 50n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_SKILL_BUFF_3RD))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 100n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_SKILL_BUFF_4TH))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 30n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_SKILL_BUFF_MUSIC))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 60n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_SKILL_BUFF_GUILD))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 60n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_ITEM_BUFF))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            saveDataArrayOld[13],
            ((1n << 70n) - 1n),
        ...
        // 時限効果設定（旧：時限効果設定）
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_TIME_BUFF))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 20n) - 1n),
        ...
        // データ加工
        // TODO: マジックナンバー
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_AUTO_SPELLS))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 60n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_CHARA_DEBUFF))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 50n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_CHARA_CONF_BASIC))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_CHARA_CONF_SPECIALIZE))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_CHARA_CONF_SKILL))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
        ...
        // モンスター基本情報（旧：モンスター選択）
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_MOB))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
        ...
        //--------------------------------
        {
            ...
            const BIAS_TARGET_INDEX_ARRAY_CONF_PLAYER_500 = [
                ...
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_MIZU_ZOKUSEI_... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_MIZU_ZOKUSEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_CHI_ZOKUSEI_T... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_CHI_ZOKUSEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_HI_ZOKUSEI_TA... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_HI_ZOKUSEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_KAZE_ZOKUSEI_... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_KAZE_ZOKUSEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_DOKU_ZOKUSEI_... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_DOKU_ZOKUSEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_SEI_ZOKUSEI_T... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_SEI_ZOKUSEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_YAMI_ZOKUSEI_... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_YAMI_ZOKUSEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_NEN_ZOKUSEI_T... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_NEN_ZOKUSEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_FUSHI_ZOKUSEI... Remove this comment to see the full error message
                ...
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_MAHOU_TAISEI'... Remove this comment to see the full error message
                MOB_CONF_PLAYER_ID_MAHOU_TAISEI,
                MOB_CONF_PLAYER_ID_DORAM_KEI_TAISEI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_STR'.
                MOB_CONF_PLAYER_ID_STR,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_AGI'.
                MOB_CONF_PLAYER_ID_AGI,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_VIT'.
                MOB_CONF_PLAYER_ID_VIT,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_INT'.
                MOB_CONF_PLAYER_ID_INT,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_DEX'.
                MOB_CONF_PLAYER_ID_DEX,
                // @ts-expect-error TS(2304): Cannot find name 'MOB_CONF_PLAYER_ID_LUK'.
                MOB_CONF_PLAYER_ID_LUK,
                MOB_CONF_PLAYER_ID_KOGATA_TAISEI,
            ];

            const signValueArray = [];
            for (var idx = 0; idx < n_B_TAISEI.length; idx++) {
            ...
            saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_MOB_CONF_PLAYER))();
            [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
                0,
                ((1n << 78n) - 1n),
        ...
        //--------------------------------
        {
            ...
            saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_MOB_CONF_INPUT))();
            [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
                0,
                ((1n << 32n) - 1n),
        ...
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_MOB_BUFF))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 80n) - 1n),
        ...
        // （領域的には81個用意されていたが末尾は使用していなかったので切り捨て）
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_MOB_DEBUFF))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 80n) - 1n),
        ...
        // 攻撃手段情報（旧：攻撃手段）
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_ATTACK_CONF))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((0x01 << 12) - 1),
        ...
        // 性能カスタマイズ（特性ステータス）
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_CHARA_CONF_SPEC_BASIC))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 24n) - 1n),
            ...(new Array(1).fill(0)),
        ...
        // 装備：矢
        //--------------------------------
        saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_EQUIP_ARROW))();
        [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
            0,
            ((1n << 1n) - 1n),
        ...
        //--------------------------------
        {
            ...
            saveDataUnit = new (CSaveDataUnitTypeManager.getUnitClass(SaveDataUnit.TYPE_MOB_CONF_PLAYER2))();
            [dataTextWork, bitOffset] = saveDataUnit.convertFromOldFormat(dataTextWork, bitOffset,
                0,
                ((1n << 82n) - 1n),
