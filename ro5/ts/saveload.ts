...
function OnClickSaveSaveData() {
    // 必要情報の取得
    // @ts-expect-error TS(2304): Cannot find name 'HtmlGetObjectValueById'.
...
export function ConvertDataTextMIG(loadDataUrl) {
    ...
    // 対象データのバージョンを取得
    //----------------------------------------------------------------
    // @ts-expect-error TS(2304): Cannot find name 'GetSaveDataVersion'.
    ...
    //----------------------------------------------------------------
    // @ts-expect-error TS(2304): Cannot find name 'VersionModify'.
    ...
    // カレントバージョンのデータ長定義を取得
    //----------------------------------------------------------------
    // @ts-expect-error TS(2304): Cannot find name 'saveDataMappingArrayCurrent'.
