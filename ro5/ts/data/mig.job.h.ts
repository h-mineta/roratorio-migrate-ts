...
// 職業系統
const JOB_SERIES_ID_NOVICE = 0;
const JOB_SERIES_ID_SUPERNOVICE = 20;

const JOB_SERIES_ID_SWORDMAN = 1;
const JOB_SERIES_ID_THIEF = 2;
const JOB_SERIES_ID_ACOLYTE = 3;
const JOB_SERIES_ID_ARCHER = 4;
const JOB_SERIES_ID_MAGICIAN = 5;
const JOB_SERIES_ID_MERCHANT = 6;

const JOB_SERIES_ID_KNIGHT = 7;
const JOB_SERIES_ID_ASSASIN = 8;
const JOB_SERIES_ID_PRIEST = 9;
const JOB_SERIES_ID_HUNTER = 10;
const JOB_SERIES_ID_WIZARD = 11;
const JOB_SERIES_ID_BLACKSMITH = 12;
const JOB_SERIES_ID_CRUSADER = 13;
const JOB_SERIES_ID_ROGUE = 14;
const JOB_SERIES_ID_MONK = 15;
const JOB_SERIES_ID_BARD = 16;
const JOB_SERIES_ID_DANCER = 17;
const JOB_SERIES_ID_SAGE = 18;
const JOB_SERIES_ID_ALCHEMIST = 19;

const JOB_SERIES_ID_TAEGKUON = 41;
const JOB_SERIES_ID_NINJA = 44;
const JOB_SERIES_ID_GUNSLINGER = 45;

const JOB_SERIES_ID_SUMMONER = 51;
 ...
 * @return 職業系統ＩＤ（０～
 */
export function GetLowerJobSeriesID(jobID: number) {
 ...
 * @return 職業系統ＩＤ（０～
 */
export function GetHigherJobSeriesID(jobID: number) {
    ...
    switch (jobID) {
        ...
        case JOB_ID_SUMMONER:
            // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_SUMMONER'.
            return JOB_SERIES_ID_SUMMONER;
 ...
 */
export function IsDoramJob(jobID: number): boolean {
 ...
 */
export function IsDualArmsJob(jobID: number): boolean {

    // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_ASSASIN'.
 ...
 */
// @ts-expect-error TS(7006): Parameter 'jobIdTarget' implicitly has an 'any' ty... Remove this comment to see the full error message
export function IsSameJobClass(jobIdTarget, jobIdCheck = n_A_JOB) {

    var jobIdArrayCheck: any[] = [];
 ...
 * @param jobId ジョブＩＤ
 */
export function GetJobLevelMax(jobId: number): number {
...
export function IsUsableHSPJob(jobId) {
    ...
    switch (GetHigherJobSeriesID(jobId)) {
        // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_PRIEST'.
        case JOB_SERIES_ID_PRIEST:
        // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_BARD'.
        case JOB_SERIES_ID_BARD:
        // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_DANCER'.
...
export function IsUsableBSPJob(jobId) {
    ...
    switch (GetLowerJobSeriesID(jobId)) {
        // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_SWORDMAN'.
        case JOB_SERIES_ID_SWORDMAN:
        // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_MERCHANT'.
        case JOB_SERIES_ID_MERCHANT:
        // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_TAEGKUON'.
    ...
    // 使用できる上位職業系統
    switch (GetHigherJobSeriesID(jobId)) {
        // @ts-expect-error TS(2304): Cannot find name 'JOB_SERIES_ID_WIZARD'.
...
export function GetBaseExpTable(tableId) {
    ...
    switch (tableId) {
        ...
        // 未転生
        // @ts-expect-error TS(2304): Cannot find name 'BASE_EXP_TABLE_ID_NORMAL'.
        ...
        // 転生
        // @ts-expect-error TS(2304): Cannot find name 'BASE_EXP_TABLE_ID_REINCANATED'.
...
export function GetJobExpTable(tableId) {
    ...
    switch (tableId) {
        ...
        // ノービス
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_NOVICE'.
        ...
        // 転生ノービス
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_NOVICE_REINCANA... Remove this comment to see the full error message
        ...
        // 一次職
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_1ST'.
        ...
        // 転生一次職
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_1ST_REINCANATED... Remove this comment to see the full error message
        ...
        // 二次職
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_2ND'.
        ...
        // 転生二次職
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_2ND_REINCANATED... Remove this comment to see the full error message
        ...
        // 拡張一次職
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_EXTRA_1ST'.
        ...
        // 拳聖
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_STAR_GRADIATOR'... Remove this comment to see the full error message
        ...
        // 三次職
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_3RD'.
        ...
        // スーパーノービス
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_SUPER_NOVICE'.
        ...
        // サモナー
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_SUMMONER'.
        ...
        // 四次職
        // @ts-expect-error TS(2304): Cannot find name 'JOB_EXP_TABLE_ID_4TH'.
 ...
 * @returns
 */
// @ts-expect-error TS(2304): Cannot find name 'g_unconfirmedHPSPArray'.
...
export function UpgradeJobTo4th() {
    ...
    // インジケーター表示
    // @ts-expect-error TS(2304): Cannot find name 'showLoadingIndicator'.
    ...
    setTimeout(() => {
        ...
        LoadSelect2();
        // インジケーター非表示
        // @ts-expect-error TS(2304): Cannot find name 'hideLoadingIndicator'.
