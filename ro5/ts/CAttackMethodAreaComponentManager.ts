...
function CAttackMethodData() {
    ...
    this.GetFullId = function () {
        ...
        switch (this.sourceType) {
            ...
            // @ts-expect-error TS(2304): Cannot find name 'ATTACK_METHOD_SOURCE_TYPE_USABLE... Remove this comment to see the full error message
            case ATTACK_METHOD_SOURCE_TYPE_USABLE_SKILL:
                // @ts-expect-error TS(2304): Cannot find name 'USABLE_SKILL_ID_CUSTOM_BIAS'.
                fullId += USABLE_SKILL_ID_CUSTOM_BIAS;
                break;

            // @ts-expect-error TS(2304): Cannot find name 'ATTACK_METHOD_SOURCE_TYPE_AUTO_S... Remove this comment to see the full error message
            case ATTACK_METHOD_SOURCE_TYPE_AUTO_SPELL:
                // @ts-expect-error TS(2304): Cannot find name 'AUTO_SPELL_ID_CUSTOM_BIAS'.
...
// 攻撃手段データの配列
// @ts-expect-error TS(7008): Member 'attackMethodDataArray' implicitly has an '... Remove this comment to see the full error message
CAttackMethodAreaComponentManager.attackMethodDataArray = [];

// 生成されたラベル部品の配列
// @ts-expect-error TS(7008): Member 'labelObjectArray' implicitly has an 'any[]... Remove this comment to see the full error message
CAttackMethodAreaComponentManager.labelObjectArray = [];

// 生成された選択部品の配列
// @ts-expect-error TS(7008): Member 'selectObjectArray' implicitly has an 'any[... Remove this comment to see the full error message
...
CAttackMethodAreaComponentManager.RebuildAttackMethodSelectSubOptionSubCreate = function (objectIndex, attackMethodOptList, selectedValueArray, valueToRestore) {
    ...
    switch (attackMethodOptList.GetType()) {
        ...
        case ATTACK_METHOD_OPTION_LIST_TYPE_SELECT:
            ...
            // スキルIDとスキルレベルを取得
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_TUZYO_KOGEKI'.
            ...
            switch (skillid) {
                ...
                // メテオストーム
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_METEOR_STORM'.
                ...
                // ファイアーウォーク
                // エレクトリックウォーク
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FIRE_WALK'.
                case SKILL_ID_FIRE_WALK:
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ELECTRIC_WALK'.
        ...
        case ATTACK_METHOD_OPTION_LIST_TYPE_INPUT:
            ...
            switch (skillid) {
                ...
                // カートレボリューション
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_CART_REVOLUTION'.
...
CAttackMethodAreaComponentManager.GetEffectiveAttackMethodDataArray = function () {
    ...
    for (idx = 0; idx < attackSkillIdArray.length; idx++) {
        ...
        // @ts-expect-error TS(2304): Cannot find name 'ATTACK_METHOD_SOURCE_TYPE_JOB_LE... Remove this comment to see the full error message
    ...
    usableSkillIdArray = new Array().concat(
        // @ts-expect-error TS(2304): Cannot find name 'GetEquippedSPListEquip'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'GetEquippedSPListCardAndElse'.
    ...
    if (n_A_PassSkill7[15]) {
        usableSkillIdArray = usableSkillIdArray.concat([
            ...
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_FIRE_BALL_5'.
            USABEL_SKILL_ID_FIRE_BALL_5,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_FIRE_WALL_5'.
            USABEL_SKILL_ID_FIRE_WALL_5,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_COLO_BOLT_5'.
            USABEL_SKILL_ID_COLO_BOLT_5,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_FROST_DIVER_5'.
            USABEL_SKILL_ID_FROST_DIVER_5,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_LIGHTNING_BOLT_5... Remove this comment to see the full error message
            USABEL_SKILL_ID_LIGHTNING_BOLT_5,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_EARTH_SPIKE_5'.
            USABEL_SKILL_ID_EARTH_SPIKE_5,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_SOUL_STRIKE_5'.
            USABEL_SKILL_ID_SOUL_STRIKE_5,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_METEOR_STORM_5'.
            USABEL_SKILL_ID_METEOR_STORM_5,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_HEAL_10'.
            USABEL_SKILL_ID_HEAL_10,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_RESERECTION_BY_Y... Remove this comment to see the full error message
            USABEL_SKILL_ID_RESERECTION_BY_YGGDRASILLNO_HA,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_GRAND_CROSS_10'.
            USABEL_SKILL_ID_GRAND_CROSS_10,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_DEMONIC_FIRE_3'.
            USABEL_SKILL_ID_DEMONIC_FIRE_3,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_HELL_INFERNO_3'.
            USABEL_SKILL_ID_HELL_INFERNO_3,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_MAGMA_ILLUPTION_... Remove this comment to see the full error message
            USABEL_SKILL_ID_MAGMA_ILLUPTION_3,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_PSYCHIC_WAVE_3'.
            USABEL_SKILL_ID_PSYCHIC_WAVE_3,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_METALIC_SOUND_3'... Remove this comment to see the full error message
            USABEL_SKILL_ID_METALIC_SOUND_3,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_JUDEX_3'.
            USABEL_SKILL_ID_JUDEX_3,
            // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_TEIOAPUCHAGI_7'.
    ...
    // @ts-expect-error TS(2304): Cannot find name 'bufLv'.
    if ((bufLv = g_confDataYozi[CCharaConfYozi.CONF_ID_KOGEKI_SOCHI_YUKOKA]) > 0) {
        // @ts-expect-error TS(2304): Cannot find name 'USABEL_SKILL_ID_KOGEKI_SOCHI_YUK... Remove this comment to see the full error message
    ...
    for (idx = 0; idx < usableSkillIdArray.length; idx++) {
        ...
        // @ts-expect-error TS(2304): Cannot find name 'InsertSkill'.
    ...
    if (IsEnableMigrationBlockNewProcess()) {
        ...
        ignoreAttrArray = [
            ...
            // @ts-expect-error TS(2304): Cannot find name 'MIG_EQUIPABLE_SP_ATTRIBUTE_ID_TA... Remove this comment to see the full error message
        ...
        for (idx = 0; idx < spTagArray.length; idx++) {
            ...
            for (idxCollected = 0; idxCollected < collectedArrayArray.length; idxCollected++) {
                ...
                for (idxArray = 0; idxArray < collectedIdArray.length; idxArray++) {
                    ...
                    attackMethodData = new CAttackMethodData();
                    attackMethodData.SetSkillId(skillId);
                    // @ts-expect-error TS(2304): Cannot find name 'ATTACK_METHOD_BY_MIG_EQUIPABLE_S... Remove this comment to see the full error message
...
CAttackMethodAreaComponentManager.GetEffectiveAttackMethodDataArraySubExtractOptions = function (attackMethodDataArray) {
    ...
    for (idx = 0; idx < attackMethodDataArray.length; idx++) {
        ...
        switch (skillId) {
            ...
            // 修羅：地雷震
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_RUWACH'.
            case SKILL_ID_RUWACH:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_PHANTOM_MENUS'.
            case SKILL_ID_PHANTOM_MENUS:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ZIRAISHIN'.
            ...
            // 特殊：アースクエイク
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_NAPALM_BEAT'.
            case SKILL_ID_NAPALM_BEAT:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_NAPALM_VULKAN'.
            case SKILL_ID_NAPALM_VULKAN:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SHINDOZANKYO'.
            case SKILL_ID_SHINDOZANKYO:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_MUCHANAGE'.
            case SKILL_ID_MUCHANAGE:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_EARTH_QUAKE'.
            ...
            case SKILL_ID_CART_TORNADO:
                ...
                // バイオロではない場合は選択させない
                // @ts-expect-error TS(2304): Cannot find name 'MIG_JOB_ID_BIOLO'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SPORE_EXPLOSION'.
            ...
            // ウィザード：ストームガスト
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_STORM_GUST'.
            ...
            // モンク：阿修羅覇凰拳
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ASHURA_HAOKEN'.
            ...
            // モンク：三段掌コンボ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_COMBO_SANDAN_MONK'.
            case SKILL_ID_COMBO_SANDAN_MONK:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_RENDASHO'.
                attackMethodOptList = funcCreateOptionListAsSkillLvSelect(attackMethodOptList, SKILL_ID_RENDASHO, true, -1);

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_MORYUKEN'.
                attackMethodOptList = funcCreateOptionListAsSkillLvSelect(attackMethodOptList, SKILL_ID_MORYUKEN, true, -1);

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ASHURA_HAOKEN_SPKOTEI'.
            ...
            // ナイト：チャージアタック
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_CHARGE_ATTACK'.
            ...
            // ハンター：ビーストストレイフィング
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_BEAST_STRAIFING'.
            ...
            // 忍者：手裏剣投げ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SHURIKEN_NAGE'.
            ...
            // 影狼朧：八方苦無
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KUNAI_NAGE'.
            case SKILL_ID_KUNAI_NAGE:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_HAPPO_KUNAI'.
            ...
            // 忍者：一閃
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ISSEN'.
            case SKILL_ID_ISSEN:
            ...
            // 忍者：一閃(MAXHP固定)
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ISSEN_MAX'.
            ...
            // ガンスリンガー：デスペラード
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_DEATHPERAD'.
            ...
            // チャンピオン：三段掌コンボ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_COMBO_SANDAN_CHAMP'.
            case SKILL_ID_COMBO_SANDAN_CHAMP:
                ...
                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_BUKKOKEN'.
                attackMethodOptList = funcCreateOptionListAsSkillLvSelect(attackMethodOptList, SKILL_ID_BUKKOKEN, true, -1);

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_RENCHUHOGEKI'.
            ...
            // ルーンナイト：ハンドレッドスピア
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_HANDRED_SPEAR'.
            case SKILL_ID_HANDRED_SPEAR:
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SPIRAL_PIERCE'.
            ...
            // スパイラルピアース
            // マッドネスクラッシャー
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_PIERCE'.
            ...
            // ルーンナイト：ウォータードラゴンブレス
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FIRE_DRAGON_BREATH'.
            case SKILL_ID_FIRE_DRAGON_BREATH:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_WATER_DRAGON_BREATH'.
            ...
            // ギロチンクロス：ダークイリュージョン
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_DARK_ILLUSION'.
            case SKILL_ID_DARK_ILLUSION:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_CROSS_IMPACT'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_CROSS_RIPPER_SLASHER'.
            ...
            // レンジャー：エイムドボルト
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_AIMED_BOLT'.
            ...
            // レンジャー：鋭敏な嗅覚
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_EIBINNA_KYUKAKU'.
            case SKILL_ID_EIBINNA_KYUKAKU:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_WUG_BITE'.
            ...
            // ウォーロック：ソウルエクスパンション
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SOUL_EXPANSION'.
            ...
            // ウォーロック：ジャックフロスト
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_JACK_FROST'.
            ...
            // ウォーロック：コメット
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_COMMET'.
            ...
            // ウォーロック：チェーンライトニング
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_CHAIN_LIGHTNING'.
            ...
            // ウォーロック：テトラボルテックス
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_TETRA_BOLTEX'.
            ...
            // ウォーロック：サモンストーン
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SUMMON_FIRE_BALL'.
            case SKILL_ID_SUMMON_FIRE_BALL:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SUMMON_WATER_BALL'.
            case SKILL_ID_SUMMON_WATER_BALL:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SUMMON_LIGHTNING_BALL'.
            case SKILL_ID_SUMMON_LIGHTNING_BALL:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SUMMON_STONE'.
            ...
            // メカニック：パワースイング
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_POWER_SWING'.
            ...
            // メカニック：アームズキャノン
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ARMS_CANNON'.
            case SKILL_ID_ARMS_CANNON:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2322): Type 'never[]' is not assignable to type 'number'.
                arrayWork = [];
                for (idxOpt = 0; idxOpt < CanonOBJ.length; idxOpt++) {
                    // @ts-expect-error TS(2339): Property 'push' does not exist on type 'number'.
            ...
            // ジェネティック：カートキャノン
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_CART_CANNON'.
            ...
            // メカニック：セルフディストラクション
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SELF_DESTRUCTION'.
            ...
            // ロイヤルガード：バニシングポイント
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_BANISHING_POINT'.
            case SKILL_ID_BANISHING_POINT:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_BASH'.
            ...
            // ロイヤルガード：レイジバーストアタック
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_RAGE_BURST_ATTACK'.
            ...
            // ロイヤルガード：オーバーブランド
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_OVER_BLAND'.
            case SKILL_ID_OVER_BLAND:
                ...
                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SPEAR_QUICKEN'.
            ...
            // ロイヤルガード：ムーンスラッシャー
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_MOON_SLUSHER'.
            ...
            // 修羅：双龍脚
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SORYUKYAKU'.
            ...
            // 修羅：爆気散弾
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_BAKKISANDAN'.
            ...
            // 修羅：修羅身弾
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SHURASHINDAN'.
            ...
            // 修羅：羅刹破凰撃(HPSP固定)
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_TENRACHIMO'.
            case SKILL_ID_TENRACHIMO:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_GOHO'.
            case SKILL_ID_GOHO:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_RASETSU_HAOGEKI_MAX'.
            ...
            // 修羅：閃光連撃
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SENKO_RENGEKI'.
            case SKILL_ID_SENKO_RENGEKI:
                ...
                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_DAITENHOSUI'.
            ...
            // 修羅：羅刹破凰撃(HPSP変動可)
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_RASETSU_HAOGEKI'.
            ...
            // 修羅：破碎柱
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_HASAICHU'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_GREAT_ECHO'.
            ...
            // ソーサラー：スペルフィスト
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SPELL_FIST'.
            ...
            // ソーサラー：サイキックウェーブ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_PSYCHIC_WAVE'.
            ...
            // ソーサラー：アースグレイヴ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_EARTH_GRAVE'.
            case SKILL_ID_EARTH_GRAVE:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SEISMIC_WEAPON'.
            ...
            // ソーサラー：ダイアモンドダスト
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_DIAMOND_DUST'.
            case SKILL_ID_DIAMOND_DUST:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FROST_WEAPON'.
            ...
            // ソーサラー：ヴェラチュールスピアー
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_VERATURE_SPEAR'.
            case SKILL_ID_VERATURE_SPEAR:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_LIGHTNING_LOADER'.
                attackMethodOptList = funcCreateOptionListAsLearnLvSelect(attackMethodOptList, SKILL_ID_LIGHTNING_LOADER, -1);

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_STRIKING'.
            ...
            // ジェネティック：スリングアイテム
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SLING_ITEM'.
            ...
            // ジェネティック：クレイジーウィード
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_CRAZY_WEED'.
            ...
            // ジェネティック：ヘルズプラント
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_HELLS_PLANT'.
            case SKILL_ID_HELLS_PLANT:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_BIOPLANT'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FIRE_EXPANSION'.
            case SKILL_ID_FIRE_EXPANSION:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ACID_DEMONSTRATION'.
            ...
            // 影狼・朧：十文字切り
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ZYUMONZIGIRI'.
            ...
            // 影狼・朧：黄泉返し
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_YOMIGAESHI'.
            ...
            // 影狼・朧：風魔手裏剣・乱華
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FUMASHURIKEN_RANKA'.
            case SKILL_ID_FUMASHURIKEN_RANKA:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FUMASHURIKEN_NAGE'.
            ...
            // リベリオン：ファイアーダンス
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FIRE_DANCE'.
            ...
            // リベリオン：ハンマーオブゴッド
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_HAMMER_OF_GOD'.
            ...
            // リベリオン：ラウンドトリップ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ROUND_TRIP'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_COMBO_GIGANTSET_JOINT_B... Remove this comment to see the full error message
            case SKILL_ID_COMBO_GIGANTSET_JOINT_BEAT:

                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_JOINT_BEAT'.
                ...
                // オプションリストを生成、追加
                // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SONIC_WAVE'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_COMBO_GIGANTSET_SPIRAL_... Remove this comment to see the full error message
            ...
            // サモナー：かみつく
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KAMITSUKU'.
            ...
            // サモナー：イヌハッカメテオ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_INUHAKKA_METEOR'.
            case SKILL_ID_INUHAKKA_METEOR:
                ...
                // @ts-expect-error TS(2304): Cannot find name 'MIG_JOB_ID_SPIRIT_HANDLER'.
            ...
            // サモナー：ピッキ突き
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_PIKKI_TSUKI'.
            ...
            // 星帝：紅焔脚
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KOEN_KYAKU'.
            ...
            // 星帝：新星爆発
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SHINSE_BAKUHATSU'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SERVANT_WEAPON_PHANTOM'... Remove this comment to see the full error message
            case SKILL_ID_SERVANT_WEAPON_PHANTOM:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SERVANT_WEAPON_DEMOLISI... Remove this comment to see the full error message
            ...
            // シャドウクロス：サベージインパクト
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SAVAGE_IMPACT'.
            ...
            // シャドウクロス：エターナルスラッシュ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ETERNAL_SLASH'.
            ...
            // シャドウクロス：シャドウスタブ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SHADOW_STAB'.
            ...
            // シャドウクロス：インパクトクレーター
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_IMPACT_CRATER'.
            ...
            // ウィンドホーク：クレッシブボルト
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_CRESSIVE_VOLT'.
            ...
            // インペリアルガード：オーバースラッシュ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_OVER_SLASH'.
            ...
            // アビスチェイサー：アビススクエア
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ABYSS_SQUARE'.
            ...
            // バイオロ：アシディファイドゾーン
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ACIDIFIED_ZONE_MIZU'.
            case SKILL_ID_ACIDIFIED_ZONE_MIZU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ACIDIFIED_ZONE_CHI'.
            case SKILL_ID_ACIDIFIED_ZONE_CHI:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ACIDIFIED_ZONE_HI'.
            case SKILL_ID_ACIDIFIED_ZONE_HI:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ACIDIFIED_ZONE_KAZE'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_JACK_FROST_NOVA'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_GROUND_GRAVITATION'.
            ...
            // ナイトウォッチ：照準カウンター
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ONLY_ONE_BULLET'.
            case SKILL_ID_ONLY_ONE_BULLET:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SPIRAL_SHOOTING'.
            case SKILL_ID_SPIRAL_SHOOTING:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_MAGAZIN_FOR_ONE'.
            case SKILL_ID_MAGAZIN_FOR_ONE:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_VIGILANT_AT_NIGHT'.
            case SKILL_ID_VIGILANT_AT_NIGHT:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_WILD_FIRE'.
            ...
            // 蜃気楼・不知火：悪夢
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_GENJUTSU_KAGE_NUI'.
            case SKILL_ID_GENJUTSU_KAGE_NUI:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_GENJUTSU_KUNAI'.
            case SKILL_ID_GENJUTSU_KUNAI:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_GENZYUTSU_ANKOKURYUU'.
            ...
            // 蜃気楼・不知火：風魔手裏剣-構築-
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FUMASHURIKEN_KOUCHIKU'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_DOUBLE_BOWLING_BASH'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_MEGA_SONIC_BLOW'.
            ...
            // スピリットハンドラー：ディアーキャノン
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_DEER_CANON'.
            ...
            // スピリットハンドラー：ディアーブリーズ
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_DEER_BREEZE'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_BASIC_GRENADE'.
            case SKILL_ID_BASIC_GRENADE:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_HASTY_FIRE_IN_THE_HOLE'... Remove this comment to see the full error message
            case SKILL_ID_HASTY_FIRE_IN_THE_HOLE:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_GRENADES_DROPPING'.
            ...
            // ナイトウォッチ：ミッションボンバード
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_MISSION_BOMBARD'.
            ...
            // アークメイジ：アストラルストライク
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ASTRAL_STRIKE'.
            ...
            // アークメイジ：オールブルーム
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ALL_BLOOM'.
            ...
            // 蜃気楼＆不知火：属性砲
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SEKIEN_HOU'.
            case SKILL_ID_SEKIEN_HOU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_REIKETSU_HOU'.
            case SKILL_ID_REIKETSU_HOU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_RAIDEN_HOU'.
            case SKILL_ID_RAIDEN_HOU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KINNRYUU_HOU'.
            case SKILL_ID_KINNRYUU_HOU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_ANTEN_HOU'.
            ...
            // 蜃気楼＆不知火：影の舞
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KAGE_NO_MAI'.
            ...
            // 蜃気楼＆不知火：歪曲
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KUNAI_WAIKYOKU'.
            ...
            // 蜃気楼＆不知火：回転
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KUNAI_KAITEN'.
            ...
            // 蜃気楼＆不知火：掌握
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_FUMASHURIKEN_SHOUAKU'.
            ...
            // 蜃気楼＆不知火：影狩り
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KAGE_GARI'.
            ...
            // 蜃気楼＆不知火：影一閃
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KAGE_ISSEN'.
            ...
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SEIRYU_FU'.
            case SKILL_ID_SEIRYU_FU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_BYAKKO_FU'.
            case SKILL_ID_BYAKKO_FU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SUZAKU_FU'.
            case SKILL_ID_SUZAKU_FU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_GENBU_FU'.
            case SKILL_ID_GENBU_FU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SHIHOZIN_FU'.
            case SKILL_ID_SHIHOZIN_FU:
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_SHIHO_GOGYO_ZIN'.
            ...
            // マイスター：攻撃装置有効化
            //----------------------------------------------------------------
            // @ts-expect-error TS(2304): Cannot find name 'SKILL_ID_KOGEKI_SOCHI_YUKOKA'.
