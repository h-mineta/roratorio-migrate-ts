...
class CShadowEquipController {
    ...
    rebuildAll() {
        ...
        // 装備箇所配列
        const kindIdArray = [
            // @ts-expect-error TS(2304): Cannot find name 'ITEM_KIND_SHADOW_ARMS_RIGHT'.
            ITEM_KIND_SHADOW_ARMS_RIGHT,
            // @ts-expect-error TS(2304): Cannot find name 'ITEM_KIND_SHADOW_ARMS_LEFT'.
            ITEM_KIND_SHADOW_ARMS_LEFT,
            // @ts-expect-error TS(2304): Cannot find name 'ITEM_KIND_SHADOW_BODY'.
            ITEM_KIND_SHADOW_BODY,
            // @ts-expect-error TS(2304): Cannot find name 'ITEM_KIND_SHADOW_FOOT'.
            ITEM_KIND_SHADOW_FOOT,
            // @ts-expect-error TS(2304): Cannot find name 'ITEM_KIND_SHADOW_ACCESSARY_ON1'.
            ITEM_KIND_SHADOW_ACCESSARY_ON1,
            // @ts-expect-error TS(2304): Cannot find name 'ITEM_KIND_SHADOW_ACCESSARY_ON2'.
        ...
        // @ts-expect-error TS(2339): Property 'EQPRGN_NAME_ARMS_RIGHT' does not exist o... Remove this comment to see the full error message
        equipableCount += this.#rebuildBlock(this.constructor.EQPRGN_NAME_ARMS_RIGHT, itemIdArrayByKind[ITEM_KIND_SHADOW_ARMS_RIGHT]);
        // @ts-expect-error TS(2339): Property 'EQPRGN_NAME_ARMS_LEFT' does not exist on... Remove this comment to see the full error message
        equipableCount += this.#rebuildBlock(this.constructor.EQPRGN_NAME_ARMS_LEFT, itemIdArrayByKind[ITEM_KIND_SHADOW_ARMS_LEFT]);
        // @ts-expect-error TS(2339): Property 'EQPRGN_NAME_BODY' does not exist on type... Remove this comment to see the full error message
        equipableCount += this.#rebuildBlock(this.constructor.EQPRGN_NAME_BODY, itemIdArrayByKind[ITEM_KIND_SHADOW_BODY]);
        // @ts-expect-error TS(2339): Property 'EQPRGN_NAME_FOOT' does not exist on type... Remove this comment to see the full error message
        equipableCount += this.#rebuildBlock(this.constructor.EQPRGN_NAME_FOOT, itemIdArrayByKind[ITEM_KIND_SHADOW_FOOT]);
        // @ts-expect-error TS(2339): Property 'EQPRGN_NAME_ACCESSORY_1' does not exist ... Remove this comment to see the full error message
        ...
        // @ts-expect-error TS(2339): Property 'EQPRGN_NAME_ACCESSORY_2' does not exist ... Remove this comment to see the full error message
    ...
    #changeShadowItem(objEquipBlock, newValue) {
        ...
        // ランダムオプションタイプIDを取得する
        // @ts-expect-error TS(2304): Cannot find name 'GetRndOptTypeId'.
        ...
        for (let idx = 0; (idx < rndOptTypeList.length) && (idx < rndOptValueList.length); idx++) {
            ...
            // @ts-expect-error TS(2304): Cannot find name 'g_rndOptTypeArray'.
            ...
            // ランダムオプション種別　選択欄
            // @ts-expect-error TS(2304): Cannot find name 'SetUpRndOptKind'.
            ...
            // ランダムオプション値　選択欄
            // @ts-expect-error TS(2304): Cannot find name 'SetUpRndOptValue'.
