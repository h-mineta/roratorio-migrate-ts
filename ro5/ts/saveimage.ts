...
$(function () {
    ...
    const t = (selector: any) => {
        // @ts-expect-error TS(2581): Cannot find name '$'. Do you need to install type ... Remove this comment to see the full error message
        return $(selector).text() || $(selector).val();
    }
    const e = (selector: any, none_str = "-") => {
        if (v(selector) == "0") {
            return none_str;
        }
        return t(selector);
    ...
    const equip = (selector: any) => {
        ...
        text += equip_name + " ( ";
        // @ts-expect-error TS(2304): Cannot find name 'enchants'.
        enchants = [];
        [1, 2, 3, 4].forEach(v => {
      ...
      <table class="etc">
        ...
        <tbody>
          <tr>
            ...
            <th>錐効果</th>
            // @ts-expect-error TS(2304): Cannot find name 'CExtraInfoAreaComponentManager'.
    ...
    <div id="equip">
      <dl>
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_HEAD_TOP'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_HEAD_MID'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_HEAD_UNDER'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_BODY'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_ARMS'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_ARMS_LEFT'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_SHOULDER'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_SHOES'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_ACCESSARY_1'.
        ...
        // @ts-expect-error TS(2304): Cannot find name 'EQUIP_REGION_ID_ACCESSARY_2'.
    ...
    `;
        ...
        // @ts-expect-error TS(2304): Cannot find name 'html2canvas'.
